...
📧 *Email:* ${bookingData.email}
📱 *Phone:* ${bookingData.phone || "Not provided"}
📅 *Date:* ${bookingData.meeting_date || "TBD"}
⏰ *Time:* ${bookingData.meeting_time || "TBD"}
💻 *Platform:* ${bookingData.meeting_platform}
${bookingData.lead_temperature ? `🌡️ *Lead:* ${bookingData.lead_temperature.toUpperCase()}` : ""}
${bookingData.service_interest ? `🛠️ *Services:* ${bookingData.service_interest}` : ""}

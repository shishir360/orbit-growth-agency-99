...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-gray-50 to-orange-50/30">
        {/* Animated gradient orbs */}
        <div className="absolute top-20 left-10 w-[500px] h-[500px] bg-gradient-to-r from-orange-500/20 to-orange-400/10 rounded-full blur-[150px] animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-[600px] h-[600px] bg-gradient-to-r from-orange-400/15 to-red-400/10 rounded-full blur-[120px] animate-pulse" style={{animationDelay: '1s'}}></div>
        
        {/* Grid pattern overlay */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,.03)_1px,transparent_1px)] bg-[size:80px_80px]"></div>
        ...
        <div className="container-wide section-padding relative z-10 pt-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="space-y-8 animate-fade-in" style={{ animationDuration: '0.4s' }}>
              {/* Premium badge */}
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-100 to-orange-50 border border-orange-200 text-gray-800 px-6 py-3 rounded-full text-sm font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button asChild size="lg" className="group text-base px-10 py-7 bg-gradient-to-r from-orange-500 to-orange-600 text-white hover:from-orange-600 hover:to-orange-700 rounded-full transition-all duration-300 hover:scale-105 font-semibold shadow-lg shadow-orange-500/25">
                  <Link to="/contact" className="flex items-center gap-2">
                    Start Your Project
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="group text-base px-10 py-7 border-2 border-gray-200 text-gray-800 bg-white hover:bg-gray-50 rounded-full transition-all duration-300">
            ...
            <div className="relative animate-scale-in" style={{animationDelay: '0.3s'}}>
              <div className="absolute -inset-6 bg-gradient-to-r from-orange-400/30 via-orange-500/25 to-orange-400/20 rounded-3xl blur-3xl opacity-70"></div>
              <div className="relative bg-white p-1.5 rounded-3xl shadow-2xl border border-gray-100">
                <YouTubeFacade
                  videoId="jQJqW8JAWWU"
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-20 lg:mt-28">
            {[
              { icon: Globe, label: "Web Design", color: "from-orange-500 to-orange-600", glow: "shadow-orange-500/30", href: "/website-design" },
              { icon: Target, label: "Paid Ads", color: "from-orange-500 to-orange-600", glow: "shadow-orange-500/30", href: "/ads-management" },
              { icon: Bot, label: "AI Automation", color: "from-orange-500 to-orange-600", glow: "shadow-orange-500/30", href: "/ai-automation" },
              { icon: Sparkles, label: "Strategy", color: "from-orange-500 to-orange-600", glow: "shadow-orange-500/30", href: "/contact" },
            ].map((service, i) => (
              <motion.div
                key={i}
              ...
              >
                <Link 
                  to={service.href}
                  className="group relative flex items-center gap-4 bg-white hover:bg-gray-50 border border-gray-200 hover:border-orange-300 rounded-2xl px-7 py-5 transition-all duration-500 cursor-pointer hover:scale-105 shadow-sm hover:shadow-lg"
                >
                  {/* Glow effect */}
                  <div className={`absolute inset-0 bg-gradient-to-r ${service.color} opacity-0 group-hover:opacity-10 rounded-2xl blur-xl transition-opacity duration-500`}></div>
                  <div className={`relative w-12 h-12 rounded-xl bg-gradient-to-br ${service.color} flex items-center justify-center shadow-lg ${service.glow}`}>
                  ...
                  <ChevronRight className="relative w-5 h-5 text-gray-400 group-hover:text-orange-500 group-hover:translate-x-1 transition-all duration-300" />
                </Link>
              </motion.div>
            ))}
          </div>
      ...
      {/* Services Section */}
      <section className="py-36 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="absolute top-20 left-10 w-[600px] h-[600px] bg-gradient-to-r from-orange-400/10 to-orange-300/5 rounded-full blur-[180px]"></div>
        <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-gradient-to-r from-orange-300/8 to-orange-400/5 rounded-full blur-[150px]"></div>
        <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,.02)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,.02)_1px,transparent_1px)] bg-[size:80px_80px]"></div>
        
        <div className="container-wide section-padding relative z-10">
          <div className="text-center mb-24">
            <div className="inline-flex items-center gap-3 bg-orange-100 border border-orange-200 text-orange-700 px-8 py-4 rounded-full text-sm font-semibold mb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {[
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${service.color} rounded-3xl blur-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-700`}></div>
                <div className="relative bg-white border border-gray-200 rounded-3xl p-10 hover:border-orange-300 hover:shadow-xl transition-all duration-500 h-full group-hover:translate-y-[-8px]">
                  ...
                  <div className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center mb-8 shadow-xl ${service.glow}`}>
      ...
      {portfolioProjects.length > 0 && imagesLoaded && (
        <section className="py-32 bg-white relative overflow-hidden">
          {/* Background Effects */}
          <div className="absolute top-20 left-10 w-[600px] h-[600px] bg-gradient-to-r from-orange-500/10 to-orange-400/5 rounded-full blur-[180px]"></div>
          <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-gradient-to-r from-orange-400/8 to-orange-300/5 rounded-full blur-[150px]"></div>
          <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,.02)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,.02)_1px,transparent_1px)] bg-[size:80px_80px]"></div>
          ...
          <div className="container-wide section-padding relative z-10">
            <div className="text-center mb-16">
              <motion.div 
                ...
                className="inline-flex items-center gap-3 bg-orange-100 border border-orange-200 text-orange-700 px-8 py-4 rounded-full text-sm font-semibold mb-10 shadow-sm"
              >
            ...
            <div className="relative max-w-5xl mx-auto">
              {/* Project Display */}
              <div className="relative h-[500px] lg:h-[600px] rounded-3xl overflow-hidden border border-gray-200 shadow-2xl">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12">
                      ...
                      >
                        <div className="inline-flex items-center gap-2 bg-orange-500/20 backdrop-blur-md border border-orange-500/30 px-4 py-2 rounded-full text-sm text-white mb-4">
                  ...
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-500 ${
                      i === currentProjectIndex 
                        ? 'w-12 bg-gradient-to-r from-orange-500 to-orange-600' 
              ...
              <div className="text-center mt-12">
                <Button asChild variant="outline" className="border-2 border-orange-300 text-orange-600 hover:bg-orange-50 rounded-xl px-8 py-6 text-lg">
                  <Link to="/portfolio">
      ...
      {/* Stats Section */}
      <section className="py-24 bg-gradient-to-r from-orange-50 via-white to-orange-50 relative overflow-hidden">
        ...
        <div className="container-wide section-padding relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="group bg-white border border-gray-200 rounded-2xl p-8 hover:border-orange-300 hover:shadow-lg transition-all duration-300 text-center">
      ...
      {/* Why Choose Us */}
      <section className="py-32 bg-white relative overflow-hidden">
        <div className="absolute top-20 right-10 w-[500px] h-[500px] bg-gradient-to-r from-orange-500/10 to-orange-400/5 rounded-full blur-[150px]"></div>
        <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,.01)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,.01)_1px,transparent_1px)] bg-[size:60px_60px]"></div>
        
        <div className="container-wide section-padding relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3 bg-orange-100 border border-orange-200 text-orange-700 px-6 py-3 rounded-full text-sm font-medium">
                <Shield className="w-4 h-4" />
                Why Lunexo Media
              </div>
              
              <h2 className="text-4xl lg:text-6xl font-bold text-gray-900" style={{fontFamily: "'Playfair Display', serif"}}>
                Built for <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">Success</span>
              </h2>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4 bg-gray-50 border border-gray-200 rounded-xl p-4 hover:border-orange-300 transition-colors">
            ...
            <div className="relative">
              <div className="absolute -inset-6 bg-gradient-to-r from-orange-400/20 to-orange-500/15 rounded-3xl blur-3xl opacity-50"></div>
              <div className="relative bg-white p-2 rounded-3xl border border-gray-200 shadow-2xl">
                <img
                  src={heroDashboard}
      ...
      {visibleTestimonials.length > 0 && (
        <section className="py-32 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          <div className="absolute bottom-20 left-10 w-[400px] h-[400px] bg-gradient-to-r from-orange-500/10 to-orange-400/5 rounded-full blur-[120px]"></div>
          
          <div className="container-wide section-padding relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 bg-orange-100 border border-orange-200 text-orange-700 px-6 py-3 rounded-full text-sm font-medium mb-8">
                <Star className="w-4 h-4" />
                Client Reviews
              </div>
              
              <h2 className="text-4xl lg:text-6xl font-bold mb-6 text-gray-900" style={{fontFamily: "'Playfair Display', serif"}}>
                What Clients <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">Say</span>
              </h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {visibleTestimonials.slice(0, 3).map((testimonial, i) => (
                <div key={i} className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-orange-300 hover:shadow-lg transition-all duration-300">
      ...
      {/* CTA Section */}
      <section className="py-32 bg-gradient-to-br from-orange-500 via-orange-600 to-red-500 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-r from-white/10 to-white/5 rounded-full blur-[100px]"></div>
        ...
        <div className="container-wide section-padding relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="group text-base px-10 py-7 bg-white text-orange-600 hover:bg-gray-100 rounded-full transition-all duration-300 hover:scale-105 font-semibold shadow-lg">
                <Link to="/contact" className="flex items-center gap-2">
                  Start Your Project
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Link>

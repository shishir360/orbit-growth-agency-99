          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              ...
              <button className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-left">
                ...
                <p className="text-xs text-gray-500">Write article</p>
              </button>
              <button className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-left">
                <Image className="h-5 w-5 text-orange-600 mb-2" />
                <p className="text-sm font-medium">Upload Image</p>
                <p className="text-xs text-gray-500">Add media files</p>
              </button>
              <button className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-left">
                <Globe className="h-5 w-5 text-green-600 mb-2" />
                <p className="text-sm font-medium">New Page</p>
                <p className="text-xs text-gray-500">Create page</p>
              </button>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Online and operational</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">2,847 unique visitors</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">95% uptime this month</p>
              </div>
            </div>
          </div>
        </CardContent>
